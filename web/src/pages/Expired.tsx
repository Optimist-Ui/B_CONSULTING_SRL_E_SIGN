...
const expiredDocuments: ExpiredDocument[] = [
    {
        id: 1,
        name: 'Annual Contract 2023.pdf',
        status: 'Expired',
        addedOn: '2023-01-20',
        expiryDate: '2023-12-31',
        formFillers: ['Alex Turner', 'Maria Garcia'],
        approvers: ['Robert Chen'],
        signers: ['Diana Ross'],
        receivers: ['Chris Martin'],
...
const Expired = () => {
    ...
    const [filteredDocuments, setFilteredDocuments] = useState<ExpiredDocument[]>(expiredDocuments);

    useEffect(() => {
        const filtered = expiredDocuments.filter((doc) => 
                                        ...
                                        <div className="dropdown" onClick={(e) => e.stopPropagation()}>
                                            ...
                                            >
                                                <ul className="!min-w-[160px]">
                                                    <li>
                                                        <button type="button" className="w-full text-left px-4 py-2 hover:bg-secondary/10">
                                                            View Details
                                                        </button>
                                                    </li>
                                                    <li>
                                        ...
                                        <td colSpan={8}>
                                            <div className="bg-gray-50 p-4">
                                                <div className="grid grid-cols-4 gap-4 mb-4 bg-white p-3 rounded shadow-sm">
                                                    ...
                                                    <div>
                                                        <span className="font-semibold">Expiry Date:</span> {doc.expiryDate}
                                                    </div>
                                                </div>
